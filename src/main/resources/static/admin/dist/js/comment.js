$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [
            {label: 'id', name: 'id', index: 'commentId', width: 50, key: true, hidden: true},
            {label: '评论人名称', name: 'username', index: 'username', width: 60},
            {label: '评论博客标题', name: 'articleTitle', index: 'articleTitle', width: 120},
            {label: '评论内容', name: 'content', index: 'commentBody', width: 120},
            {label: '评论时间', name: 'createtime', index: 'commentCreateTime', width: 60},
        ],
        height: 700,
        rowNum: 18,
        rowList: [10, 20, 50],
